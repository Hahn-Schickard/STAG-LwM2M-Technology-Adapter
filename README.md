...
## Description
Implements a Technology Adapter for Lighweight Machine To Machine (LwM2M) Communications protocol. The adapter functions as a LwM2M Server and uses Hahn-Schickar LwM2M Server for C++17 implementation.
